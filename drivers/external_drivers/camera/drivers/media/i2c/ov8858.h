...
extern int wv517_vcm_power_up(struct v4l2_subdev *sd);
extern int wv517_vcm_power_down(struct v4l2_subdev *sd);
extern int wv517_vcm_init(struct v4l2_subdev *sd);
extern int wv517_t_focus_vcm(struct v4l2_subdev *sd, u16 val);
extern int wv517_t_focus_abs(struct v4l2_subdev *sd, s32 value);
extern int wv517_t_focus_rel(struct v4l2_subdev *sd, s32 value);
extern int wv517_q_focus_status(struct v4l2_subdev *sd, s32 *value);
extern int wv517_q_focus_abs(struct v4l2_subdev *sd, s32 *value);
extern int wv517_t_vcm_slew(struct v4l2_subdev *sd, s32 value);
extern int wv517_t_vcm_timing(struct v4l2_subdev *sd, s32 value);
extern int wv517_vcm_power_up(struct v4l2_subdev *sd);
extern int wv517_vcm_power_down(struct v4l2_subdev *sd);
extern int wv517_vcm_init(struct v4l2_subdev *sd);
extern int wv517_t_focus_vcm(struct v4l2_subdev *sd, u16 val);
...
static struct ov8858_vcm ov8858_vcms[] = {
	[OV8858_SUNNY] = {
		.power_up = wv517_vcm_power_up,
		.power_down = wv517_vcm_power_down,
		.init = wv517_vcm_init,
		.t_focus_vcm = wv517_t_focus_vcm,
		.t_focus_abs = wv517_t_focus_abs,
		.t_focus_rel = wv517_t_focus_rel,
		.q_focus_status = wv517_q_focus_status,
		.q_focus_abs = wv517_q_focus_abs,
		.t_vcm_slew = wv517_t_vcm_slew,
		.t_vcm_timing = wv517_t_vcm_timing,
	},
	[OV8858_ID_DEFAULT] = {
...
static struct ov8858_reg ov8858_BasicSettings[] = {
	...
	{OV8858_8BIT, 0x501e, 0x93}, /* digital gain */
...
static const struct ov8858_reg ov8858_3216x1816[] = {
	...
	{OV8858_8BIT, 0x4601, 0xc9}, /* Unknown */
	{OV8858_8BIT, 0x4837, 0x14}, /* pclk_period = 0x14 */
	{OV8858_8BIT, 0x382D, 0xFF},
	{OV8858_8BIT, 0x3841, 0xFF},
	{OV8858_TOK_TERM, 0, 0}
...
static const struct ov8858_reg ov8858_1640_1232_30[] = {
    ...
    {OV8858_8BIT, 0x3508,  0x04}, // ; gain H
    {OV8858_8BIT, 0x3808,  0x06}, // ; x output size H
    {OV8858_8BIT, 0x3809,  0x60}, //;60 ; x output size L
    {OV8858_8BIT, 0x380a,  0x04}, // ; y output size H
    {OV8858_8BIT, 0x380b,  0xc8}, //;c8 ; y output size L
    {OV8858_8BIT, 0x380c,  0x07}, // ; HTS H
    {OV8858_8BIT, 0x380d,  0x94}, //;88 ; HTS L
    {OV8858_8BIT, 0x380e,  0x0a}, //;09;04 ; VTS H
    {OV8858_8BIT, 0x380f,  0x0d}, //;aa;dc ; VTS L
    {OV8858_8BIT, 0x3814,  0x03}, // ; x odd inc
    {OV8858_8BIT, 0x3815,  0x01}, // ; x even inc
    {OV8858_8BIT, 0x3821,  0x67}, // ; mirror on, bin on
    {OV8858_8BIT, 0x382a,  0x03}, // ; y odd inc
    {OV8858_8BIT, 0x382b,  0x01}, // ; y even inc
    {OV8858_8BIT, 0x3830,  0x08}, //
    {OV8858_8BIT, 0x3836,  0x02}, //
    {OV8858_8BIT, 0x3f0a,  0x00}, //
    {OV8858_8BIT, 0x4001,  0x10}, // ; total 128 black column
