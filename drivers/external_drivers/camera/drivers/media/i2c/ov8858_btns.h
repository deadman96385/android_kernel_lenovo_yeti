...
static struct ov8858_reg ov8858_BasicSettings[] = {
	...
	{OV8858_8BIT, 0x303f, 0x01},
	{OV8858_8BIT, 0x3012, 0x6c},
	...
	{OV8858_8BIT, 0x3605, 0x28}, /* Unknown */
	...
	{OV8858_8BIT, 0x3501, 0x4A},
	{OV8858_8BIT, 0x3502, 0x60},
	/*
	...
	{OV8858_8BIT, 0x3703, 0x33}, /* Unknown */
	...
	{OV8858_8BIT, 0x3769, 0x66}, /* Unknown */
	{OV8858_8BIT, 0x376A, 0x24}, /* Unknown */
	...
	{OV8858_8BIT, 0x377A, 0x0C}, /* Unknown */
	...
	{OV8858_8BIT, 0x3812, 0x02}, /* v_win offset high */
	{OV8858_8BIT, 0x3813, 0x01}, /* v_win offset low */
...
/*	{OV8858_8BIT, 0x4500, 0x38}, */ /* Unknown */
	...
	{OV8858_8BIT, 0x4837, 0x13}, /* pclk_period = 0x13 */
...
static const struct ov8858_reg ov8858_8M[] = {
	...
	{OV8858_8BIT, 0x380C, 0x07}, /* horizontal timing size high */
	{OV8858_8BIT, 0x380D, 0xC0}, /* horizontal timing size low */
	{OV8858_8BIT, 0x380E, 0x09}, /* vertical timing size high */
	{OV8858_8BIT, 0x380F, 0xCE}, /* vertical timing size low */
	{OV8858_8BIT, 0x3810, 0x00},
	{OV8858_8BIT, 0x3811, 0x07},
...
static const struct ov8858_reg ov8858_6M[] = {
	...
	{OV8858_8BIT, 0x3803, 0x32}, /* v_crop_start low */
	{OV8858_8BIT, 0x3804, 0x0C}, /* h_crop_end high */
	{OV8858_8BIT, 0x3805, 0xDF}, /* h_crop_end low */
	{OV8858_8BIT, 0x3806, 0x08}, /* v_crop_end high */
	{OV8858_8BIT, 0x3807, 0x7D}, /* v_crop_end low */
	...
	{OV8858_8BIT, 0x380C, 0x07}, /* horizontal timing size high */
	{OV8858_8BIT, 0x380D, 0xA0}, /* horizontal timing size low */
	{OV8858_8BIT, 0x380E, 0x09}, /* vertical timing size high */
	{OV8858_8BIT, 0x380F, 0xAE}, /* vertical timing size low */
	{OV8858_8BIT, 0x3810, 0x00},
	{OV8858_8BIT, 0x3811, 0x09},
	{OV8858_8BIT, 0x3812, 0x00},
	{OV8858_8BIT, 0x3813, 0x08},
	{OV8858_8BIT, 0x3814, 0x01}, /* h_odd_inc */
	{OV8858_8BIT, 0x3815, 0x01}, /* h_even_inc */
...
static const struct ov8858_reg ov8858_1632x1232[] = {
	...
	{OV8858_8BIT, 0x4022, 0x06},
	{OV8858_8BIT, 0x4023, 0x00},
	{OV8858_8BIT, 0x4024, 0x0F},
	{OV8858_8BIT, 0x4025, 0x2A},
	{OV8858_8BIT, 0x4026, 0x0F},
	{OV8858_8BIT, 0x4027, 0x2B},
	{OV8858_8BIT, 0x4028, 0x00},
...
static struct ov8858_resolution ov8858_res_preview[] = {
	...
	},
	{
		...
		.fps_options = {
			{
				.fps = 30,
				.pixels_per_line = 3904,
				.lines_per_frame = 2510,
			},
			{
			}
		},
