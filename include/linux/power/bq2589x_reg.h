...
#define BQ2589X_ADC_CONTINUE_DISABLE 1
...
#define BQ2589X_PG_NOT_GOOD        0
#define BQ2589X_PG_GOOD                1
...
struct bq2589x_platform_data{
	int     gpio_irq;    // irq line
	int     gpio_ce;     // chip enable line
	int     gpio_otg;    // otg line

	bool    en_ico;
	bool    en_hvdcp;
	bool    en_maxcharge;
	bool    auto_dpdm;
	bool    adc_continue_convert;

	bool    enable_watchdog;
	int     watchdog_timeout;

	bool    enable_charge_timer;
	int     charge_timeout;
	...
	bool    enable_ilimit_pin;

	int     vindpm_offset;

	bool    force_vindpm;

	struct  bq2589x_charge_param charge_param[BQ2589X_VBUS_TYPE_NUM - 1];
};
