...
//	rt5677_set_dsp_mode(codec, true);
	...
	rt5677_reset(codec);    // write register for resetting

	rt5677_reg_init(codec);    // initialise rt5677 with init_list
	
	/* creating files in sys/bus/i2c/devices/0-002c/ */
		    ...
		    const struct i2c_device_id *id)
{
	...
	i2c->addr = 0x2c;    // address is 0x2c, so sys/bus/i2c/devices/0-002c/
